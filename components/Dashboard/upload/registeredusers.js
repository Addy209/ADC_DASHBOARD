...
mutation($date:Date!, $mbIncremental:Int!, $upiIncremental:Int!){
  addIncrementalUser(date:$date, mbinc:$mbIncremental, upiinc:$upiIncremental){
    success
  }
}
`
...
const RegisteredUsers = (props) => {
  ...
  return (
    ...
    onFinish={onFinish}>
      ...
      >
        <InputNumber min={0} style={{width:200}} placeholder="MB Incremental Registered Users"/>
      ...
      >
        <InputNumber min={0} style={{width:200}} placeholder="UPI Incremental Registered Users" />
